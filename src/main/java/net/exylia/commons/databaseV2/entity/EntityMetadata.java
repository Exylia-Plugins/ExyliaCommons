...
import net.exylia.commons.databaseV2.annotation.Index;
...
public class EntityMetadata {
    ...
    private void scanFields() {
        for (Field field : entityClass.getDeclaredFields()) {
            if (field.isAnnotationPresent(Column.class)) {
                ...
                if (field.isAnnotationPresent(net.exylia.commons.databaseV2.annotation.Index.class)) {
    ...
    private List<Index> scanIndexes() {
        ...
        if (entityClass.isAnnotationPresent(net.exylia.commons.databaseV2.annotation.Indexes.class)) {
            net.exylia.commons.databaseV2.annotation.Indexes indexes = entityClass.getAnnotation(net.exylia.commons.databaseV2.annotation.Indexes.class);
    ...
    private Column createDefaultColumn(String name, boolean pk) {
        return new Column() {
            ...
            @Override
            public net.exylia.commons.databaseV2.annotation.SerializationType serializationType() {
                return net.exylia.commons.databaseV2.annotation.SerializationType.AUTO;
            }
