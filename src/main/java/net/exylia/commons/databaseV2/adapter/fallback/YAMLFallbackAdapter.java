package net.exylia.commons.databaseV2.adapter.fallback;
...
public class YAMLFallbackAdapter implements DatabaseAdapter {
    ...
    public void connect() throws Exception {
        ...
        DebugUtils.logInfo("YAML Fallback adapter initialized at " + basePath);
    }
    ...
    public void disconnect() throws Exception {
        saveAll();
        tableCache.clear();
        DebugUtils.logInfo("YAML Fallback adapter disconnected");
    }
    ...
    private List<Map<String, Object>> getTable(String tableName) {
        return tableCache.computeIfAbsent(tableName, k -> {
            try {
                ...
                DebugUtils.logWarn("Failed to load table " + k);
