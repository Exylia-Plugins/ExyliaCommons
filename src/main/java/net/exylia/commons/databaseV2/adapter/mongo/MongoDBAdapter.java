package net.exylia.commons.databaseV2.adapter.mongo;
...
public class MongoDBAdapter implements DatabaseAdapter {
    ...
    public void connect() throws Exception {
        try {
            ...
            DebugUtils.logInfo("Connected to MongoDB");
        } catch (Exception e) {
            DebugUtils.logError("Failed to connect to MongoDB: " + e.getMessage());
            throw e;
        }
    }
    ...
    public void disconnect() throws Exception {
        if (mongoClient != null) {
            mongoClient.close();
            DebugUtils.logInfo("Disconnected from MongoDB");
        }
    }
