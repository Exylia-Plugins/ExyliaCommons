...
public class ItemStackExtractor {
    ...
    private static void extractPotionConfig(ItemStack itemStack, ItemData.ItemDataBuilder builder) {
        ...
        net.exylia.commons.v2.items.config.PotionConfig potionConfig = new net.exylia.commons.v2.items.config.PotionConfig();
    ...
    private static void extractLeatherArmorColor(ItemStack itemStack, ItemData.ItemDataBuilder builder) {
        ...
        try {
            ...
            if (color != null) {
                net.exylia.commons.v2.items.config.LeatherArmorConfig leatherConfig = new net.exylia.commons.v2.items.config.LeatherArmorConfig();
