...
@Getter
public class DateFormatterV2 extends AbstractFormatter<Object, String> {
    private final DateFormatterConfig config;
    private final TimeFormatterV2 timeFormatter;

    DateFormatterV2(FormatterCache cache, DateFormatterConfig config) {
        super(cache);
        this.config = config;
        this.timeFormatter = TimeFormatterV2.builder().cache(cache).build();
    }
