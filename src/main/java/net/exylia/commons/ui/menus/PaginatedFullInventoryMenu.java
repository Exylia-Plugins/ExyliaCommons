...
public class PaginatedFullInventoryMenu extends FullInventoryMenu {
    ...
    public PaginatedFullInventoryMenu(String title, int rows, int... itemSlots) {
        super(title, rows);
    ...
    public PaginatedFullInventoryMenu(String title, int rows, String itemSlotsString) {
        super(title, rows);
    ...
    public PaginatedFullInventoryMenu(String title, int rows, int[] itemSlots, ExyliaContext context) {
    ...
    public PaginatedFullInventoryMenu(String title, int rows, String itemSlotsString, ExyliaContext context) {
        super(title, rows, context);
        int[] itemSlots = parseSlots(itemSlotsString, rows);
        this.itemSlots = itemSlots.clone();
        this.itemsPerPage = itemSlots.length;
    ...
    public PaginatedFullInventoryMenu addItem(MenuItem item) {
        paginationItems.add(item);
        return this;
    }

    public PaginatedFullInventoryMenu addItems(Collection<MenuItem> items) {
        paginationItems.addAll(items);
        return this;
    }

    public PaginatedFullInventoryMenu setItems(Collection<MenuItem> items) {
        paginationItems.clear();
        paginationItems.addAll(items);
        return this;
    }

    public PaginatedFullInventoryMenu clearItems() {
        paginationItems.clear();
        return this;
    }

    public PaginatedFullInventoryMenu updateItem(int index, MenuItem item) {
    ...
    public PaginatedFullInventoryMenu setPreviousButton(MenuItem button, int slot) {
        this.previousButton = button;
        this.previousButtonSlot = slot;
        return this;
    }

    public PaginatedFullInventoryMenu setNextButton(MenuItem button, int slot) {
        this.nextButton = button;
        this.nextButtonSlot = slot;
        return this;
    }

    public PaginatedFullInventoryMenu setItemSlotFiller(MenuItem filler) {
