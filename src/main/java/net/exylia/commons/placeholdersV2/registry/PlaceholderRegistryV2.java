package net.exylia.commons.placeholdersV2.registry;
...
import net.exylia.commons.placeholdersV2.async.AsyncPlaceholderExecutor;
import net.exylia.commons.placeholdersV2.cache.PlaceholderCacheV2;
import net.exylia.commons.placeholdersV2.context.PlaceholderContext;
import net.exylia.commons.placeholdersV2.exception.PlaceholderRegistrationException;
...
import net.exylia.commons.placeholdersV2.resolver.PlaceholderResolver;
import net.exylia.commons.placeholdersV2.resolver.PlayerPlaceholderResolver;
import net.exylia.commons.placeholdersV2.scanner.PlaceholderAnnotationScanner;
